...
<body>
    <form action="{url_to_redirect_to}" method="post">
        ...
        <h2>Login</h2>
        <p class="subtitle">Access your OrizonLLM Admin UI.</p>
        <div class="info-box">
            ...
            <p>By default, Username is <code>admin</code> and Password is your set OrizonLLM Proxy <code>MASTER_KEY</code>.</p>
